      ...
      <div className="">
        ...
        <div className="space-y-1 mb-6 md:w-[405px]">
          <Link href="/students/add">
            <button className="w-full text-left  py-3 border-t border-[#E4E6EA]  flex gap-2 items-center">
              Add Single Student{" "}
              <span>
          ...
          <button
            onClick={() => onNext()}
            className="w-full text-left  py-3 border-y border-[#E4E6EA] flex gap-2 items-center"
          >
