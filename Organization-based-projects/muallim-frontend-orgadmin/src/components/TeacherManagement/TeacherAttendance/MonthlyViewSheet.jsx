...
const statusColors = {
  ...
  CL: "bg-[#FFF3E7] text-[#DC7803]",
  EL: "bg-[#FFF3E7] text-[#DC7803]",
  WE: "bg-[#E7F7FF] text-[#B6BFF0]",
  A: "bg-red-100 text-red-700",
  SL: "bg-[#FFF3E7] text-[#DC7803]",
...
// ----------- Component starts -----------
export default function MonthlyViewSheet({ currentDate, onDateChange }) {
  // ----------- State Management -----------
  ...
  }, [startDate, endDate, page, limit, filter, dataType]);
  ...
  const getAttendanceCounts = (teacher) => {
    ...
    return {
      ...
      leaveCount: statusArr.filter((s) => s === "CL" || s === "SL").length,
  ...
  return (
    <>
      ...
      <div className="w-full overflow-x-auto h-[666px]">
        ...
        {isFetching && (
          <div className="flex justify-center items-center h-64">
            {/* <td colSpan={dates.length + 3} className="fletext-center py-4"> */}
            <SvgLoader />
          </div>
        )}
      </div>
