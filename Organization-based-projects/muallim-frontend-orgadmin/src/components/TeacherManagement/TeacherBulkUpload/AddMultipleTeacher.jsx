...
const AddMultipleTeacher = ({ onComplete, onBack }) => {
  ...
  return (
    <div className=" p-4 bg-white">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">Add Multiple Teachers</h2>
      ...
      {uploadMethod === "spreadsheet" ? (
        <>
          ...
          <p className="text-12 text-gray-500 my-4 tracking-wider">
            Upload the excel file of teacher information. File formats - .xlsx.
...
export default AddMultipleTeacher;
